...
import {FaHome,FaPhone,FaMailBulk,FaInstagram,FaLinkedin,FaGithub,FaGoogle} from "react-icons/fa";
        ...
        <div className="footer-container">
            <div className="left">
                <div className="location">
                    ...
                    <div>
                        <p>Dogar Basti,Street No.13(R),</p>
                        <p>Faridkot,Punjab</p>
                    </div>
                </div>
               <div className="phone">
               ...
               <div className="email">
                    <h4>
                        ...
                        harmanjotkainth@gmail.com
                    </h4>
               </div>
            </div>
            <div className="right">
                <h4>Feel free to contact me...</h4>
                <p>This is Harmanjot Kaur.I enjoy discussing new projects and design challenges.</p>
                <div className="social">
                    ...
                    <a href ="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=harmanjotkainth@gmail.com" target="_blank"> <FaGoogle size={30} style={{color:'#fff',marginRight:"1rem" ,cursor:"pointer"}}/></a>
                </div>
            </div>
        </div>   
    </div>
