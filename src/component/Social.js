  ...
  return (
    <>
        <div className="images" style={{zIndex:20}}>
            ...
            <a href="mailto:harmanjot0555.be21@chitkara.edu.in" target="_blank" ><img src="https://cdn.pixabay.com/photo/2019/10/19/17/24/gmail-4561841_960_720.png" alt="email" className="emaillogo"/></a><br/>
